...
DONE- When a user loads the page, they should see all trainers, with their current
  team of Pokemon.
DONE- Whenever a user hits "Add Pokemon" and they have space on their team, they
  should get a new Pokemon.
DONE- Whenever a user hits "Release Pokemon" on a specific Pokemon team, that
  specific Pokemon should be released from the team.
